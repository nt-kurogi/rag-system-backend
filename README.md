...
- `AZURE_OPENAI_DEPLOYMENT_GPT56_SOL`（GPT-5.6 SolのAzureデプロイ名）
- `AZURE_OPENAI_DEPLOYMENT_GPT56_TERRA`（任意、GPT-5.6 Terra）
- `AZURE_OPENAI_DEPLOYMENT_GPT56_LUNA`（任意、GPT-5.6 Luna）
